import{a as lt,b as L,c as cr,d as Z,e as Ye,f as I,g as Rt,h as ee,i as ot,j as dr}from"./chunk-XVOTX5KS.mjs";import{a as pr}from"./chunk-X4GG3EDV.mjs";import{a as _e,b as Ie,c as fr}from"./chunk-5JIJA4QV.mjs";var mr="0.0.0-insiders.68fcdf1";function at(e){let i=[0];for(let n=0;n<e.length;n++)e.charCodeAt(n)===10&&i.push(n+1);function r(n){let s=0,l=i.length;for(;l>0;){let f=(l|0)>>1,c=s+f;i[c]<=n?(s=c+1,l=l-f-1):l=f}s-=1;let p=n-i[s];return{line:s+1,column:p}}function t({line:n,column:s}){n-=1,n=Math.min(Math.max(n,0),i.length-1);let l=i[n],p=i[n+1]??l;return Math.min(Math.max(l+s,0),p)}return{find:r,findOffset:t}}var Ge=92,st=47,ut=42,gr=34,hr=39,ln=58,ft=59,de=10,ct=13,qe=32,He=9,vr=123,Pt=125,It=40,wr=41,on=91,an=93,kr=45,Ot=64,sn=33,me=class e extends Error{loc;constructor(i,r){if(r){let t=r[0],n=at(t.code).find(r[1]);i=`${t.file}:${n.line}:${n.column+1}: ${i}`}super(i),this.name="CssSyntaxError",this.loc=r,Error.captureStackTrace&&Error.captureStackTrace(this,e)}};function Se(e,i){let r=i?.from?{file:i.from,code:e}:null;e[0]==="\uFEFF"&&(e=" "+e.slice(1));let t=[],n=[],s=[],l=null,p=null,f="",c="",m=0,d;for(let u=0;u<e.length;u++){let h=e.charCodeAt(u);if(!(h===ct&&(d=e.charCodeAt(u+1),d===de)))if(h===Ge)f===""&&(m=u),f+=e.slice(u,u+2),u+=1;else if(h===st&&e.charCodeAt(u+1)===ut){let v=u;for(let y=u+2;y<e.length;y++)if(d=e.charCodeAt(y),d===Ge)y+=1;else if(d===ut&&e.charCodeAt(y+1)===st){u=y+1;break}let k=e.slice(v,u+1);if(k.charCodeAt(2)===sn){let y=pt(k.slice(2,-2));n.push(y),r&&(y.src=[r,v,u+1],y.dst=[r,v,u+1])}}else if(h===hr||h===gr){let v=br(e,u,h,r);f+=e.slice(u,v+1),u=v}else{if((h===qe||h===de||h===He)&&(d=e.charCodeAt(u+1))&&(d===qe||d===de||d===He||d===ct&&(d=e.charCodeAt(u+2))&&d==de))continue;if(h===de){if(f.length===0)continue;d=f.charCodeAt(f.length-1),d!==qe&&d!==de&&d!==He&&(f+=" ")}else if(h===kr&&e.charCodeAt(u+1)===kr&&f.length===0){let v="",k=u,y=-1;for(let A=u+2;A<e.length;A++)if(d=e.charCodeAt(A),d===Ge)A+=1;else if(d===hr||d===gr)A=br(e,A,d,r);else if(d===st&&e.charCodeAt(A+1)===ut){for(let b=A+2;b<e.length;b++)if(d=e.charCodeAt(b),d===Ge)b+=1;else if(d===ut&&e.charCodeAt(b+1)===st){A=b+1;break}}else if(y===-1&&d===ln)y=f.length+A-k;else if(d===ft&&v.length===0){f+=e.slice(k,A),u=A;break}else if(d===It)v+=")";else if(d===on)v+="]";else if(d===vr)v+="}";else if((d===Pt||e.length-1===A)&&v.length===0){u=A-1,f+=e.slice(k,A);break}else(d===wr||d===an||d===Pt)&&v.length>0&&e[A]===v[v.length-1]&&(v=v.slice(0,-1));let N=_t(f,y);if(!N)throw new me("Invalid custom property, expected a value",r?[r,k,u]:null);r&&(N.src=[r,k,u],N.dst=[r,k,u]),l?l.nodes.push(N):t.push(N),f=""}else if(h===ft&&f.charCodeAt(0)===Ot)p=Ze(f),r&&(p.src=[r,m,u],p.dst=[r,m,u]),l?l.nodes.push(p):t.push(p),f="",p=null;else if(h===ft&&c[c.length-1]!==")"){let v=_t(f);if(!v){if(f.length===0)continue;throw new me(`Invalid declaration: \`${f.trim()}\``,r?[r,m,u]:null)}r&&(v.src=[r,m,u],v.dst=[r,m,u]),l?l.nodes.push(v):t.push(v),f=""}else if(h===vr&&c[c.length-1]!==")")c+="}",p=J(f.trim()),r&&(p.src=[r,m,u],p.dst=[r,m,u]),l&&l.nodes.push(p),s.push(l),l=p,f="",p=null;else if(h===Pt&&c[c.length-1]!==")"){if(c==="")throw new me("Missing opening {",r?[r,u,u]:null);if(c=c.slice(0,-1),f.length>0)if(f.charCodeAt(0)===Ot)p=Ze(f),r&&(p.src=[r,m,u],p.dst=[r,m,u]),l?l.nodes.push(p):t.push(p),f="",p=null;else{let k=f.indexOf(":");if(l){let y=_t(f,k);if(!y)throw new me(`Invalid declaration: \`${f.trim()}\``,r?[r,m,u]:null);r&&(y.src=[r,m,u],y.dst=[r,m,u]),l.nodes.push(y)}}let v=s.pop()??null;v===null&&l&&t.push(l),l=v,f="",p=null}else if(h===It)c+=")",f+="(";else if(h===wr){if(c[c.length-1]!==")")throw new me("Missing opening (",r?[r,u,u]:null);c=c.slice(0,-1),f+=")"}else{if(f.length===0&&(h===qe||h===de||h===He))continue;f===""&&(m=u),f+=String.fromCharCode(h)}}}if(f.charCodeAt(0)===Ot){let u=Ze(f);r&&(u.src=[r,m,e.length],u.dst=[r,m,e.length]),t.push(u)}if(c.length>0&&l){if(l.kind==="rule")throw new me(`Missing closing } at ${l.selector}`,l.src?[l.src[0],l.src[1],l.src[1]]:null);if(l.kind==="at-rule")throw new me(`Missing closing } at ${l.name} ${l.params}`,l.src?[l.src[0],l.src[1],l.src[1]]:null)}return n.length>0?n.concat(t):t}function Ze(e,i=[]){let r=e,t="";for(let n=5;n<e.length;n++){let s=e.charCodeAt(n);if(s===qe||s===He||s===It){r=e.slice(0,n),t=e.slice(n);break}}return B(r.trim(),t.trim(),i)}function _t(e,i=e.indexOf(":")){if(i===-1)return null;let r=e.indexOf("!important",i+1);return o(e.slice(0,i).trim(),e.slice(i+1,r===-1?e.length:r).trim(),r!==-1)}function br(e,i,r,t=null){let n;for(let s=i+1;s<e.length;s++)if(n=e.charCodeAt(s),n===Ge)s+=1;else{if(n===r)return s;if(n===ft&&(e.charCodeAt(s+1)===de||e.charCodeAt(s+1)===ct&&e.charCodeAt(s+2)===de))throw new me(`Unterminated string: ${e.slice(i,s+1)+String.fromCharCode(r)}`,t?[t,i,s+1]:null);if(n===de||n===ct&&e.charCodeAt(s+1)===de)throw new me(`Unterminated string: ${e.slice(i,s)+String.fromCharCode(r)}`,t?[t,i,s+1]:null)}return i}var U=class extends Map{constructor(r){super();this.factory=r}factory;get(r){let t=super.get(r);return t===void 0&&(t=this.factory(r,this),this.set(r,t)),t}};function ne(e){return{kind:"word",value:e}}function un(e,i){return{kind:"function",value:e,nodes:i}}function fn(e){return{kind:"separator",value:e}}function F(e){let i="";for(let r of e)switch(r.kind){case"word":case"separator":{i+=r.value;break}case"function":i+=r.value+"("+F(r.nodes)+")"}return i}var yr=92,cn=41,xr=58,Ar=44,pn=34,Cr=61,Vr=62,Sr=60,$r=10,dn=40,mn=39,gn=47,Tr=32,Nr=9;function M(e){e=e.replaceAll(`\r
`,`
`);let i=[],r=[],t=null,n="",s;for(let l=0;l<e.length;l++){let p=e.charCodeAt(l);switch(p){case yr:{n+=e[l]+e[l+1],l++;break}case gn:{if(n.length>0){let c=ne(n);t?t.nodes.push(c):i.push(c),n=""}let f=ne(e[l]);t?t.nodes.push(f):i.push(f);break}case xr:case Ar:case Cr:case Vr:case Sr:case $r:case Tr:case Nr:{if(n.length>0){let d=ne(n);t?t.nodes.push(d):i.push(d),n=""}let f=l,c=l+1;for(;c<e.length&&(s=e.charCodeAt(c),!(s!==xr&&s!==Ar&&s!==Cr&&s!==Vr&&s!==Sr&&s!==$r&&s!==Tr&&s!==Nr));c++);l=c-1;let m=fn(e.slice(f,c));t?t.nodes.push(m):i.push(m);break}case mn:case pn:{let f=l;for(let c=l+1;c<e.length;c++)if(s=e.charCodeAt(c),s===yr)c+=1;else if(s===p){l=c;break}n+=e.slice(f,l+1);break}case dn:{let f=un(n,[]);n="",t?t.nodes.push(f):i.push(f),r.push(f),t=f;break}case cn:{let f=r.pop();if(n.length>0){let c=ne(n);f?.nodes.push(c),n=""}r.length>0?t=r[r.length-1]:t=null;break}default:n+=String.fromCharCode(p)}}return n.length>0&&i.push(ne(n)),i}var Kt=(l=>(l[l.Continue=0]="Continue",l[l.Skip=1]="Skip",l[l.Stop=2]="Stop",l[l.Replace=3]="Replace",l[l.ReplaceSkip=4]="ReplaceSkip",l[l.ReplaceStop=5]="ReplaceStop",l))(Kt||{}),V={Continue:{kind:0},Skip:{kind:1},Stop:{kind:2},Replace:e=>({kind:3,nodes:Array.isArray(e)?e:[e]}),ReplaceSkip:e=>({kind:4,nodes:Array.isArray(e)?e:[e]}),ReplaceStop:e=>({kind:5,nodes:Array.isArray(e)?e:[e]})};function _(e,i){typeof i=="function"?Er(e,i):Er(e,i.enter,i.exit)}function Er(e,i=()=>V.Continue,r=()=>V.Continue){let t={value:[e,0,null],prev:null},n={parent:null,depth:0,index:0,siblings:e,path(){let s=[],l=t;for(;l;){let p=l.value[2];p&&s.push(p),l=l.prev}return s.reverse(),s}};for(;t!==null;){let s=t.value,l=s[0],p=s[1],f=s[2];if(p>=l.length){t=t.prev,n.depth-=1;continue}if(n.parent=f,n.siblings=l,p>=0){n.index=p;let u=l[p],h=i(u,n)??V.Continue;switch(h.kind){case 0:{u.nodes&&u.nodes.length>0&&(n.depth+=1,t={value:[u.nodes,0,u],prev:t}),s[1]=~p;continue}case 2:return;case 1:{s[1]=~p;continue}case 3:{l.splice(p,1,...h.nodes);continue}case 5:{l.splice(p,1,...h.nodes);return}case 4:{l.splice(p,1,...h.nodes),s[1]+=h.nodes.length;continue}default:throw new Error(`Invalid \`WalkAction.${Kt[h.kind]??`Unknown(${h.kind})`}\` in enter.`)}}let c=~p;n.index=c;let m=l[c],d=r(m,n)??V.Continue;switch(d.kind){case 0:s[1]=c+1;continue;case 2:return;case 3:{l.splice(c,1,...d.nodes),s[1]=c+d.nodes.length;continue}case 5:{l.splice(c,1,...d.nodes);return}case 4:{l.splice(c,1,...d.nodes),s[1]=c+d.nodes.length;continue}default:throw new Error(`Invalid \`WalkAction.${Kt[d.kind]??`Unknown(${d.kind})`}\` in exit.`)}}}function dt(e){let i=[];return _(M(e),r=>{if(!(r.kind!=="function"||r.value!=="var"))return _(r.nodes,t=>{t.kind!=="word"||t.value[0]!=="-"||t.value[1]!=="-"||i.push(t.value)}),V.Skip}),i}var hn=64;function H(e,i=[]){return{kind:"rule",selector:e,nodes:i}}function B(e,i="",r=[]){return{kind:"at-rule",name:e,params:i,nodes:r}}function J(e,i=[]){return e.charCodeAt(0)===hn?Ze(e,i):H(e,i)}function o(e,i,r=!1){return{kind:"declaration",property:e,value:i,important:r}}function pt(e){return{kind:"comment",value:e}}function he(e,i){return{kind:"context",context:e,nodes:i}}function Y(e){return{kind:"at-root",nodes:e}}function re(e){switch(e.kind){case"rule":return{kind:e.kind,selector:e.selector,nodes:e.nodes.map(re),src:e.src,dst:e.dst};case"at-rule":return{kind:e.kind,name:e.name,params:e.params,nodes:e.nodes.map(re),src:e.src,dst:e.dst};case"at-root":return{kind:e.kind,nodes:e.nodes.map(re),src:e.src,dst:e.dst};case"context":return{kind:e.kind,context:{...e.context},nodes:e.nodes.map(re),src:e.src,dst:e.dst};case"declaration":return{kind:e.kind,property:e.property,value:e.value,important:e.important,src:e.src,dst:e.dst};case"comment":return{kind:e.kind,value:e.value,src:e.src,dst:e.dst};default:throw new Error(`Unknown node kind: ${e.kind}`)}}function Qe(e){return{depth:e.depth,index:e.index,siblings:e.siblings,get context(){let i={};for(let r of e.path())r.kind==="context"&&Object.assign(i,r.context);return Object.defineProperty(this,"context",{value:i}),i},get parent(){let i=this.path().pop()??null;return Object.defineProperty(this,"parent",{value:i}),i},path(){return e.path().filter(i=>i.kind!=="context")}}}function $e(e,i,r=3){let t=[],n=new Set,s=new U(()=>new Set),l=new U(()=>new Set),p=new Set,f=new Set,c=[],m=[],d=new U(()=>new Set);function u(v,k,y={},N=0){if(v.kind==="declaration"){if(v.property==="--tw-sort"||v.value===void 0||v.value===null)return;if(y.theme&&v.property[0]==="-"&&v.property[1]==="-"){if(v.value==="initial"){v.value=void 0;return}y.keyframes||s.get(k).add(v)}if(v.value.includes("var("))if(y.theme&&v.property[0]==="-"&&v.property[1]==="-")for(let A of dt(v.value))d.get(A).add(v.property);else i.trackUsedVariables(v.value);if(v.property==="animation")for(let A of Rr(v.value))f.add(A);r&2&&v.value.includes("color-mix(")&&!y.supportsColorMix&&!y.keyframes&&l.get(k).add(v),k.push(v)}else if(v.kind==="rule"){let A=[];for(let O of v.nodes)u(O,A,y,N+1);let b={},D=new Set;for(let O of A){if(O.kind!=="declaration")continue;let P=`${O.property}:${O.value}:${O.important}`;b[P]??=[],b[P].push(O)}for(let O in b)for(let P=0;P<b[O].length-1;++P)D.add(b[O][P]);if(D.size>0&&(A=A.filter(O=>!D.has(O))),A.length===0)return;v.selector==="&"?k.push(...A):k.push({...v,nodes:A})}else if(v.kind==="at-rule"&&v.name==="@property"&&N===0){if(n.has(v.params))return;if(r&1){let b=v.params,D=null,O=!1;for(let z of v.nodes)z.kind==="declaration"&&(z.property==="initial-value"?D=z.value:z.property==="inherits"&&(O=z.value==="true"));let P=o(b,D??"initial");P.src=v.src,O?c.push(P):m.push(P)}n.add(v.params);let A={...v,nodes:[]};for(let b of v.nodes)u(b,A.nodes,y,N+1);k.push(A)}else if(v.kind==="at-rule"){v.name==="@keyframes"?y={...y,keyframes:!0}:v.name==="@supports"&&v.params.includes("color-mix(")&&(y={...y,supportsColorMix:!0});let A={...v,nodes:[]};for(let b of v.nodes)u(b,A.nodes,y,N+1);v.name==="@keyframes"&&y.theme&&p.add(A),(A.nodes.length>0||A.name==="@layer"||A.name==="@charset"||A.name==="@custom-media"||A.name==="@namespace"||A.name==="@import"||A.name==="@apply")&&k.push(A)}else if(v.kind==="at-root")for(let A of v.nodes){let b=[];u(A,b,y,0);for(let D of b)t.push(D)}else if(v.kind==="context"){if(v.context.reference)return;for(let A of v.nodes)u(A,k,{...y,...v.context},N)}else v.kind==="comment"&&k.push(v)}let h=[];for(let v of e)u(v,h,{},0);e:for(let[v,k]of s)for(let y of k){if(Pr(y.property,i.theme,d)){if(y.property.startsWith(i.theme.prefixKey("--animate-")))for(let b of Rr(y.value))f.add(b);continue}let A=v.indexOf(y);if(v.splice(A,1),v.length===0){let b=vn(h,D=>D.kind==="rule"&&D.nodes===v);if(!b||b.length===0)continue e;b.unshift({kind:"at-root",nodes:h});do{let D=b.pop();if(!D)break;let O=b[b.length-1];if(!O||O.kind!=="at-root"&&O.kind!=="at-rule")break;let P=O.nodes.indexOf(D);if(P===-1)break;O.nodes.splice(P,1)}while(!0);continue e}}for(let v of p)if(!f.has(v.params)){let k=t.indexOf(v);t.splice(k,1)}if(h=h.concat(t),r&2)for(let[v,k]of l)for(let y of k){let N=v.indexOf(y);if(N===-1||y.value==null)continue;let A=M(y.value),b=!1;if(_(A,P=>{if(P.kind!=="function"||P.value!=="color-mix")return;let z=!1,E=!1;if(_(P.nodes,j=>{if(j.kind=="word"&&j.value.toLowerCase()==="currentcolor"){E=!0,b=!0;return}let q=j,G=null,X=new Set;do{if(q.kind!=="function"||q.value!=="var")return;let ie=q.nodes[0];if(!ie||ie.kind!=="word")return;let a=ie.value;if(X.has(a)){z=!0;return}if(X.add(a),b=!0,G=i.theme.resolveValue(null,[ie.value]),!G){z=!0;return}if(G.toLowerCase()==="currentcolor"){E=!0;return}G.startsWith("var(")?q=M(G)[0]:q=null}while(q);return V.Replace({kind:"word",value:G})}),z||E){let j=P.nodes.findIndex(G=>G.kind==="separator"&&G.value.trim().includes(","));if(j===-1)return;let q=P.nodes.length>j?P.nodes[j+1]:null;return q?V.Replace(q):void 0}else if(b){let j=P.nodes[2];j.kind==="word"&&(j.value==="oklab"||j.value==="oklch"||j.value==="lab"||j.value==="lch")&&(j.value="srgb")}}),!b)continue;let D={...y,value:F(A)},O=J("@supports (color: color-mix(in lab, red, red))",[y]);O.src=y.src,v.splice(N,1,D,O)}if(r&1){let v=[];if(c.length>0){let k=J(":root, :host",c);k.src=c[0].src,v.push(k)}if(m.length>0){let k=J("*, ::before, ::after, ::backdrop",m);k.src=m[0].src,v.push(k)}if(v.length>0){let k=h.findIndex(A=>!(A.kind==="comment"||A.kind==="at-rule"&&(A.name==="@charset"||A.name==="@import"))),y=B("@layer","properties",[]);y.src=v[0].src,h.splice(k<0?h.length:k,0,y);let N=J("@layer properties",[B("@supports","((-webkit-hyphens: none) and (not (margin-trim: inline))) or ((-moz-orient: inline) and (not (color:rgb(from red r g b))))",v)]);N.src=v[0].src,N.nodes[0].src=v[0].src,h.push(N)}}return h}function ae(e,i){let r=0,t={file:null,code:""};function n(l,p=0){let f="",c="  ".repeat(p);if(l.kind==="declaration"){if(f+=`${c}${l.property}: ${l.value}${l.important?" !important":""};
