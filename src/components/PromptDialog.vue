  ...
  >
    ...
    >
      ...
      <div class="flex justify-end gap-2 border-t border-[var(--oterm-border)] px-4 py-3">
        ...
        <button
          type="submit"
          class="rounded-md bg-[var(--oterm-accent)]/15 px-3 py-1.5 text-xs font-medium text-[var(--oterm-accent)] transition hover:bg-[var(--oterm-accent)]/25 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--oterm-accent)]/50 focus-visible:ring-offset-1 focus-visible:ring-offset-[var(--oterm-elevated)] disabled:cursor-not-allowed disabled:opacity-40"
